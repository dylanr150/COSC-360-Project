    ...
    <main>
      <div class = "postContainer">
        <div class = "tagsContainer"> 
          <p>View By Tags: <a href="../HTML/home.php">All Posts</a> <a id = "music" href="../PHP/music.php">Music</a> <a href="../PHP/sports.php">Sports</a> <a href="../PHP/news.php">News</a></p>
        </div>
        <?php
          $host = "localhost";
          ...
          else
          {
            ...
            $sql = "SELECT * FROM post WHERE tag = 'music' ORDER BY postID DESC";
